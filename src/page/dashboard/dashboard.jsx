    ...
    <React.Fragment>
      <div>
        ...
        <div className="flex m-2">
          <div className="w-72 h-20 bg-gradient-to-l from-[#84cc16] via-[#84cc16] to-[#84cc16] text-white  ml-72 p-1 m-1">
            <button className="font-normal text-xl text-center m-4">
              Laporan Status Proses 0
            </button>
          </div>
          <div className="w-72 h-20 bg-gradient-to-l from-[#2dd4bf] via-[#2dd4bf] to-[#2dd4bf] text-white  ml-8 p-1 m-1 ">
            <button className="font-normal text-xl text-center m-4">
              Laporan Di Tanggapi 0
            </button>
          </div>
        </div>
      </div>
